...
public class Test extends JApplet{
    ...
    class GameOverPane extends JPanel{
        public GameOverPane(int w,int h){
            setSize(w,h);
            //setOpaque(false); 绘制游戏失败界面颜色，重写了GameOverPane的setsize方法
        }
        public void paintComponent(Graphics g){
            super.paintComponent(g);
    ...
    class SuccessPane extends JPanel{
        ...
        public void paintComponent(Graphics g){
            ...
            g.setFont(font);
            FontMetrics fm=Toolkit.getDefaultToolkit().getFontMetrics(font);//这里不理解是什么意思？？？？？
    ...
    class LOGO extends JPanel{
        ...
        public void paintComponent(Graphics g){
            super.paintComponent(g);//为什么调用了父类的方法？？？
    ...
    public void gameOver(){
        ...
        jb2.setOpaque(false);//此方法是设置控件是否透明的。true表示不透明,false表示透明
        jb2.setFont(font);
